...
export async function renderStaticMeme({ width, height, topText, bottomText, color, stroke, format, origin, imageUrl, imageBuffer }) {
  const baseBuffer = await loadBaseImageBuffer({ origin, imageUrl, imageBuffer });
...
export async function renderGifMeme({ width, height, topText, bottomText, color, stroke, origin, imageUrl, imageBuffer }) {
  const rawBase = await loadBaseImageBuffer({ origin, imageUrl, imageBuffer });
